...
def calc_sltp(price: float, atr: float, direction: str,
    ...
    """SL + 3 TPs. ✅ الإصلاح: SWING_MULT_SL بدل SWING_ATR_MULT_SL"""
    is_long  = direction == "LONG"
    is_swing = "Swing" in trade_type

    # ✅ الإصلاح الجوهري: الأسماء الصحيحة من config.py
    sl_mult  = CONFIG.SWING_MULT_SL  if is_swing else CONFIG.ATR_MULT_SL
    tp1_mult = CONFIG.SWING_MULT_TP1 if is_swing else CONFIG.ATR_MULT_TP1
    tp2_mult = CONFIG.SWING_MULT_TP2 if is_swing else CONFIG.ATR_MULT_TP2
    tp3_mult = CONFIG.SWING_MULT_TP3 if is_swing else CONFIG.ATR_MULT_TP3
